...
student = {
    "submitterEmail": "chunyil3@illinois.edu", #<Your coursera account email>
    "secret": "L2ZIJCV40p68TpKp" #<Your secret token from coursera>
}
...
viz1CsvPath = "./mp9-vis1.csv" #<Filepath for your tableau viz1 csv/tsv file>
